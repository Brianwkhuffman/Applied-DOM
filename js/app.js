(function(window) {
  ...
  btn4.addEventListener("click", function(event) {
    let x = [event, "light-green"];
    setMyLightClass.apply(this, x);
  });
   ...
   *     null, 'light-green'
   */
  const setLight11Green = setMyLightClass.bind(btn11, event, "light-green");
   ...
   */
  let funcbtn14 = setMyLightGreen.bind(btn14);
